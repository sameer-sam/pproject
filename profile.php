...
<head>
    ...
    <title>College Interactive System</title>
...
<body>
    <header class="hidden-sm hidden-md hidden-lg">
        <div class="searchbox">
            <form action="profile.php?username=<?php echo $usrname;?>" method="post">
                <h1 class="text-left">College Interactive System</h1>
    ...
    <div class="footer-dark navbar-fixed-bottom">
        <footer>
            <div class="container">
                <p class="copyright">College Interactive System</p>
            </div>
        </footer>
    </div>
